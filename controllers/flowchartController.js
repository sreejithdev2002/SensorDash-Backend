...
//     const { nodes, edges } = req.body.elements;
//     try {
//         let flowchart = await Flowchart.findOne();
//         if (flowchart) {
//           // If flowchart already exists, update it
//           flowchart.nodes = nodes;
//           flowchart.edges = edges;
//         } else {
//           // Otherwise, create a new flowchart
//           flowchart = new Flowchart({ nodes, edges });
//         }
...
//     const flow = await Flowchart.findOne({ userId: req.user.id });
//     res.json(flow);
// };
...
//     const updated = await Flowchart.findByIdAndUpdate(id, { elements}, { new: true });
//     res.json(updated);
// };

// module.exports = { Save, Load, Update };
